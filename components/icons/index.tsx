// SVG Icons for The Sovereign Scale
...
export function TabletIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TvIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WatchIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
